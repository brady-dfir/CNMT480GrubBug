...
1. Create the challenge page in the templates folder (Example: AXX_2021.html)
2. Add route logic to app.py
...
3. Update solutions.db with the correct answer and explanation

4. Update users.db to include a new progress flag (SQL: ALTER TABLE users ADD COLUMN A11_2021_done INTEGER DEFAULT 0;)
